...
public class CreateDistanceFileFaceDetection {
	...
	public static void main(String [] args) throws Exception {
		...
		CsvFileWriter resultsFile = new CsvFileWriter("distance_padding_" + DetectionParameters.PADDING, DistanceParameters.DISTANCES_FILE_FD);
	    ...
	    for (int i = 0; i < (count*2); i++){
	    	...
	    	if((imgMat1.length != 0) && (imgMat2.length != 0)){
